...
def _dry_run_patch_specs() -> list[dict[str, Any]]:
    subjects = [
        (
            ...
            "src/micro_model_agent/repository_ops/infrastructure/repo_read.py",
            "RepositoryPatchTool",
            "src/micro_model_agent/repository_ops/infrastructure/test_executor.py",
            "uv run pytest src/micro_model_agent/repository_ops/infrastructure/test_executor.py",
        ),
        (
        ...
        (
            ...
            "src/micro_model_agent/execution/infrastructure/models/transformers.py",
            "max_new_tokens",
            "src/micro_model_agent/execution/infrastructure/models/test_transformers.py",
            "uv run pytest src/micro_model_agent/execution/infrastructure/models/test_transformers.py",
        ),
    ]
    variants = [
...
def _focused_test_specs() -> list[dict[str, Any]]:
    subjects = [
        ...
        (
            ...
            "src/micro_model_agent/evaluation/infrastructure/test_synthetic_behavior.py",
            "uv run pytest src/micro_model_agent/evaluation/infrastructure/test_synthetic_behavior.py",
        ),
        (
            "repository path safety helper",
            "src/micro_model_agent/repository_ops/infrastructure/paths.py",
            "ensure_relative_safe_path",
            "src/micro_model_agent/repository_ops/infrastructure/test_paths.py",
            "uv run pytest src/micro_model_agent/repository_ops/infrastructure/test_paths.py",
        ),
    ]
    variants = [
...
def _unsafe_boundary_specs() -> list[dict[str, Any]]:
    subjects = [
        ...
        (
            ...
            "src/micro_model_agent/repository_ops/infrastructure/catalog.py",
            "src/micro_model_agent/repository_ops/infrastructure/test_executor.py",
            "uv run pytest src/micro_model_agent/repository_ops/infrastructure/test_executor.py",
        ),
        (
