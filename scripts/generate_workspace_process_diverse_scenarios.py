...
def _decoy_read_search_specs() -> list[dict[str, Any]]:
    return [
        _spec(
            ...
            workspace_files={
                "src/micro_model_agent/infrastructure/dataset_prompting.py": "def synthetic_prompt_payload(example, include_tool_schemas=False):\n    return {\"input\": prompt_input, \"tool_schemas\": schemas}\n",
                "src/micro_model_agent/infrastructure/dataset_validation.py": "def _sft_trace_user_payload(example):\n    return {\"goal\": example.input.get(\"goal\", \"\"), \"tool_history\": []}\n",
                "src/micro_model_agent/infrastructure/test_synthetic_pipeline.py": "def test_sft_payload_includes_response_contract():\n    assert payload[\"response_contract\"][\"type\"] == \"tool_call\"\n",
            },
            required_files=[
                "src/micro_model_agent/infrastructure/dataset_prompting.py",
                "src/micro_model_agent/infrastructure/test_synthetic_pipeline.py",
            ],
            forbidden_files=["src/micro_model_agent/infrastructure/dataset_validation.py"],
        ...
        _spec(
            ...
            workspace_files={
                ...
                "src/micro_model_agent/infrastructure/evaluation_comparison.py": "class EvaluationComparator:\n    def compare(self, metric_thresholds):\n        return metric_thresholds\n",
            ...
            forbidden_files=["src/micro_model_agent/infrastructure/evaluation_comparison.py"],
        ...
        _spec(
            ...
            workspace_files={
                "src/micro_model_agent/infrastructure/dataset_metadata.py": "def metadata_with_tool_profile(example):\n    return {\"tool_profile\": tool_profile_for_example(example)}\n",
                "src/micro_model_agent/infrastructure/training_artifacts.py": "class TrainingArtifactStore:\n    def save(self, artifact):\n        return artifact\n",
                "src/micro_model_agent/infrastructure/test_dataset_curation.py": "def test_metadata_keeps_one_tool_profile():\n    assert \"tool_profile\" in metadata\n",
            },
            required_files=[
                "src/micro_model_agent/infrastructure/dataset_metadata.py",
                "src/micro_model_agent/infrastructure/test_dataset_curation.py",
            ],
            forbidden_files=["src/micro_model_agent/infrastructure/training_artifacts.py"],
            ...
            required_commands=[
                "uv run pytest src/micro_model_agent/infrastructure/test_dataset_curation.py"
            ],
        ...
        _spec(
            ...
            workspace_files={
                "src/micro_model_agent/infrastructure/local_index.py": "class LocalIndex:\n    def refresh(self, paths):\n        self._cache.clear()\n",
                "src/micro_model_agent/infrastructure/local_retrieval.py": "class LocalRetriever:\n    def search(self, query):\n        return self._index.search(query)\n",
                "src/micro_model_agent/infrastructure/test_local_index.py": "def test_refresh_clears_stale_entries():\n    assert index.search(\"old\") == []\n",
            },
            required_files=[
                "src/micro_model_agent/infrastructure/local_index.py",
                "src/micro_model_agent/infrastructure/test_local_index.py",
            ],
            forbidden_files=["src/micro_model_agent/infrastructure/local_retrieval.py"],
            ...
            required_commands=[
                "uv run pytest src/micro_model_agent/infrastructure/test_local_index.py"
            ],
        ...
        _spec(
            ...
            workspace_files={
                ...
                "src/micro_model_agent/infrastructure/ollama_packaging.py": "def package_ollama_adapter(path):\n    return path\n",
            ...
            forbidden_files=["src/micro_model_agent/infrastructure/ollama_packaging.py"],
        ...
        _spec(
            ...
            workspace_files={
                "src/micro_model_agent/infrastructure/dataset_validation.py": "class LocalDatasetValidator:\n    def _validate_refusal_consistency(self, example, prefix):\n        return []\n",
                "src/micro_model_agent/infrastructure/repository_paths.py": "def ensure_relative_safe_path(path):\n    if path.startswith('..'):\n        raise ValueError('unsafe')\n",
                "src/micro_model_agent/infrastructure/test_dataset_curation.py": "def test_validator_rejects_accepted_unsafe_path():\n    assert not result.passed\n",
            },
            required_files=[
                "src/micro_model_agent/infrastructure/dataset_validation.py",
                "src/micro_model_agent/infrastructure/test_dataset_curation.py",
            ],
            forbidden_files=["src/micro_model_agent/infrastructure/repository_paths.py"],
        ...
        _spec(
            ...
            workspace_files={
                "src/micro_model_agent/infrastructure/tools/git_diff.py": "class GitDiffTool:\n    def run(self, include_untracked=False):\n        return diff\n",
                "src/micro_model_agent/infrastructure/tools/test_git_diff.py": "def test_git_diff_omits_micro_model_agent_outputs():\n    assert '.micro_model_agent/datasets' not in result\n",
                "src/micro_model_agent/infrastructure/dataset_store.py": "class JsonlDatasetExampleStore:\n    pass\n",
            },
            required_files=[
                "src/micro_model_agent/infrastructure/tools/git_diff.py",
                "src/micro_model_agent/infrastructure/tools/test_git_diff.py",
            ],
            forbidden_files=["src/micro_model_agent/infrastructure/dataset_store.py"],
            ...
            required_commands=[
                "uv run pytest src/micro_model_agent/infrastructure/tools/test_git_diff.py"
            ],
        ...
        _spec(
            ...
            workspace_files={
                "src/micro_model_agent/infrastructure/trace_export.py": "class TraceDatasetExporter:\n    def export(self):\n        return [example_with_label('needs_review')]\n",
                "src/micro_model_agent/infrastructure/dataset_curation.py": "def relabel_examples(examples, outcome, quality):\n    return examples\n",
                "src/micro_model_agent/infrastructure/test_trace_export.py": "def test_exported_traces_default_to_needs_review():\n    assert example.label.outcome == 'needs_review'\n",
            },
            required_files=[
                "src/micro_model_agent/infrastructure/trace_export.py",
                "src/micro_model_agent/infrastructure/test_trace_export.py",
            ],
            forbidden_files=["src/micro_model_agent/infrastructure/dataset_curation.py"],
...
def _concrete_patch_specs() -> list[dict[str, Any]]:
    return [
        _spec(
            ...
            workspace_files={
                "src/micro_model_agent/infrastructure/workspace_staged_evaluation.py": "def _stage_metrics(scores):\n    return {\"parse_success_rate\": rate}\n",
                "src/micro_model_agent/infrastructure/test_workspace_staged_evaluation.py": "def test_report_separates_parse_and_stage_accuracy():\n    assert metrics[\"parse_success_rate\"] == 1.0\n",
        ...
        _spec(
            ...
            workspace_files={
                "src/micro_model_agent/infrastructure/tools/repo_write_patch.py": "class RepoWritePatchTool:\n    def run(self, patch, dry_run=True, expected_changed_files=None):\n        return {\"changed_files\": expected_changed_files or []}\n",
                "src/micro_model_agent/infrastructure/tools/test_repo_write_patch.py": "def test_write_patch_reports_expected_changed_files_in_order():\n    assert result[\"changed_files\"] == [\"README.md\"]\n",
                "src/micro_model_agent/infrastructure/tools/git_diff.py": "class GitDiffTool: pass\n",
            },
            required_files=[
                "src/micro_model_agent/infrastructure/tools/repo_write_patch.py",
                "src/micro_model_agent/infrastructure/tools/test_repo_write_patch.py",
            ],
            forbidden_files=["src/micro_model_agent/infrastructure/tools/git_diff.py"],
            ...
            required_commands=[
                "uv run pytest src/micro_model_agent/infrastructure/tools/test_repo_write_patch.py"
            ],
        ...
        _spec(
            ...
            workspace_files={
                "src/micro_model_agent/infrastructure/training_artifacts.py": "class TrainingArtifact:\n    dataset_sha: str | None = None\n",
                "src/micro_model_agent/infrastructure/test_training_artifacts.py": "def test_artifact_records_dataset_sha256():\n    assert artifact.dataset_sha256\n",
        ...
        _spec(
            ...
            workspace_files={
                "src/micro_model_agent/infrastructure/workspace_staged_evaluation.py": "def build_workspace_staged_review_records(...):\n    return records\n",
                "src/micro_model_agent/infrastructure/test_workspace_staged_evaluation.py": "def test_review_queue_keeps_category():\n    assert record[\"category\"] == \"docs\"\n",
        ...
        _spec(
            ...
            workspace_files={
                ...
                "src/micro_model_agent/infrastructure/test_synthetic_pipeline.py": "def test_test_run_seed_uses_command_name():\n    assert arguments[\"command_name\"]\n",
                "src/micro_model_agent/infrastructure/tools/command_runner.py": "class TestRunArguments:\n    command_name: str\n",
            },
            required_files=[
                "examples/synthetic-data/tool-use.seed.jsonl",
                "src/micro_model_agent/infrastructure/test_synthetic_pipeline.py",
            ],
            forbidden_files=["src/micro_model_agent/infrastructure/tools/command_runner.py"],
    ...
    return [
        _trace_spec(
            ...
            files={
                ...
                "src/micro_model_agent/infrastructure/synthetic_evaluation.py": "def score_final_response(expected, actual):\n    return expected in actual\n",
            ...
            forbidden_files=["src/micro_model_agent/infrastructure/synthetic_evaluation.py"],
        ...
        _trace_spec(
            ...
            files={
                ...
                "src/micro_model_agent/infrastructure/trace_export.py": "def compact_tool_history(trace):\n    return trace.tool_calls\n",
            ...
            forbidden_files=["src/micro_model_agent/infrastructure/trace_export.py"],
        ...
        _trace_spec(
            ...
            files={
                ...
                "src/micro_model_agent/infrastructure/tools/test_test_run.py": "def test_command_name_is_required():\n    assert result.status == 'failed'\n",
            ...
            forbidden_files=["src/micro_model_agent/infrastructure/tools/test_test_run.py"],
        ...
        _trace_spec(
            ...
            files={
                ...
                "src/micro_model_agent/infrastructure/tools/catalog.py": "AVAILABLE_TOOLS = ['repo.search', 'repo.read', 'test.run']\n",
            ...
            forbidden_files=["src/micro_model_agent/infrastructure/tools/catalog.py"],
        ...
        _trace_spec(
            ...
            files={
                ...
                "src/micro_model_agent/infrastructure/tools/git_diff.py": "class GitDiffArguments: pass\n",
        ...
        _trace_spec(
            ...
            files={
                ...
                "src/micro_model_agent/infrastructure/tools/repo_search.py": "class RepoSearchTool: pass\n",
            },
            required_files=["examples/trace-data/held-out.trace.jsonl", "docs/usage.md"],
            forbidden_files=["src/micro_model_agent/infrastructure/tools/repo_search.py"],
...
def _ambiguity_clarification_specs() -> list[dict[str, Any]]:
    return [
        ...
        _clarification_spec(
            ...
            files={
                "src/micro_model_agent/infrastructure/test_synthetic_pipeline.py": "def test_export_contract():\n    assert True\n",
                "src/micro_model_agent/infrastructure/test_workspace_staged_evaluation.py": "def test_stage_scores():\n    assert True\n",
        ...
        _clarification_spec(
            ...
            files={
                "src/micro_model_agent/infrastructure/training_artifacts.py": "class AdapterArtifact: pass\n",
                "src/micro_model_agent/infrastructure/tools/repo_write_patch.py": "class RepoWritePatchTool: pass\n",
        ...
        _clarification_spec(
            ...
            files={
                "src/micro_model_agent/infrastructure/synthetic_evaluation.py": "class SyntheticBehaviorEvaluationSuite: pass\n",
                "src/micro_model_agent/infrastructure/workspace_staged_evaluation.py": "class WorkspaceStagedEvaluationSuite: pass\n",
                "src/micro_model_agent/infrastructure/evaluation_comparison.py": "class EvaluationComparator: pass\n",
            },
            required_files=[
                "src/micro_model_agent/infrastructure/synthetic_evaluation.py",
                "src/micro_model_agent/infrastructure/workspace_staged_evaluation.py",
                "src/micro_model_agent/infrastructure/evaluation_comparison.py",
            ],
        ...
        _clarification_spec(
            ...
            files={
                "src/micro_model_agent/infrastructure/workspace_staged_evaluation.py": "def _contains(haystack, needle):\n    return needle in haystack\n",
...
def _repair_recovery_specs() -> list[dict[str, Any]]:
    return [
        ...
        _repair_spec(
            ...
            files={
                "src/micro_model_agent/infrastructure/dataset_prompting.py": "def prompt_payload_for_sft(example):\n    return {\"input\": example.input}\n",
                "src/micro_model_agent/infrastructure/test_synthetic_pipeline.py": "def test_prompt_payload_for_sft_keeps_contract():\n    assert payload\n",
            ...
            command="uv run pytest src/micro_model_agent/infrastructure/test_synthetic_pipeline.py",
        ...
        _repair_spec(
            ...
            files={
                "src/micro_model_agent/infrastructure/tools/command_runner.py": "class TestRunArguments:\n    command_name: str\n",
                "src/micro_model_agent/infrastructure/tools/test_test_run.py": "def test_command_key_is_rejected():\n    assert error\n",
                "docs/training-findings-handoff.md": "Stale command_key aliases caused regressions.\n",
            },
            required_files=[
                "src/micro_model_agent/infrastructure/tools/command_runner.py",
                "src/micro_model_agent/infrastructure/tools/test_test_run.py",
            ],
            ...
            changed_files=["src/micro_model_agent/infrastructure/tools/test_test_run.py"],
            command="uv run pytest src/micro_model_agent/infrastructure/tools/test_test_run.py",
        ...
        _repair_spec(
            ...
            files={
                "src/micro_model_agent/infrastructure/tools/repo_search.py": "class RepoSearchArguments:\n    query: str\n    limit: int = 20\n",
                "src/micro_model_agent/infrastructure/tools/test_repo_search.py": "def test_search_limit_is_bounded():\n    assert args.limit <= 50\n",
                "docs/training-findings-handoff.md": "repo.search.limit=250 was an observed invalid argument.",
            },
            required_files=[
                "src/micro_model_agent/infrastructure/tools/repo_search.py",
                "src/micro_model_agent/infrastructure/tools/test_repo_search.py",
            ],
            required_queries=["limit", "250"],
            diagnosis_terms=["search limit", "bounded", "too many results"],
            patch_terms=["limit", "bounded", "repo.search"],
            changed_files=["src/micro_model_agent/infrastructure/tools/test_repo_search.py"],
            command="uv run pytest src/micro_model_agent/infrastructure/tools/test_repo_search.py",
        ...
        _repair_spec(
            ...
            files={
                ...
                "src/micro_model_agent/infrastructure/tool_executor.py": "class ToolExecutor:\n    def execute(self, tool_call):\n        return result\n",
                "src/micro_model_agent/infrastructure/test_tool_executor.py": "def test_executor_rejects_unknown_tool():\n    assert error\n",
            },
            required_files=[
            ...
            command="uv run pytest src/micro_model_agent/infrastructure/test_tool_executor.py",
        ...
        _repair_spec(
            ...
            files={
                "src/micro_model_agent/infrastructure/tools/repo_search.py": "class RepoSearchArguments:\n    query: str\n    limit: int = 20\n",
                "src/micro_model_agent/infrastructure/test_synthetic_pipeline.py": "def test_search_target_omits_result_fields():\n    assert \"truncated\" not in arguments\n",
            ...
            changed_files=["src/micro_model_agent/infrastructure/test_synthetic_pipeline.py"],
            command="uv run pytest src/micro_model_agent/infrastructure/test_synthetic_pipeline.py",
        ...
        _repair_spec(
            ...
            files={
                ...
                "src/micro_model_agent/infrastructure/tools/repo_write_patch.py": "def validate_patch(patch):\n    return patch.startswith('diff --git')\n",
                "src/micro_model_agent/infrastructure/tools/test_repo_write_patch.py": "def test_rejects_prose_patch():\n    assert error\n",
            },
            required_files=[
                "docs/usage.md",
                "src/micro_model_agent/infrastructure/tools/test_repo_write_patch.py",
            ...
            changed_files=["docs/usage.md"],
            command="uv run pytest src/micro_model_agent/infrastructure/tools/test_repo_write_patch.py",
...
def _unsafe_boundary_specs() -> list[dict[str, Any]]:
    return [
        _unsafe_spec(
            ...
            safe_file="src/micro_model_agent/infrastructure/repository_paths.py",
        ...
        _unsafe_spec(
            ...
            safe_file="src/micro_model_agent/infrastructure/trace_export.py",
        ...
        _unsafe_spec(
            ...
            safe_file="src/micro_model_agent/infrastructure/dataset_validation.py",
    ...
    *,
    ...
    return _spec(
        ...
        workspace_files={
            ...
            "src/micro_model_agent/infrastructure/tools/catalog.py": "TOOLS = ['repo.search', 'repo.read', 'repo.write_patch', 'test.run', 'git.diff']\n",
        },
