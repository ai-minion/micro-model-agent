...
from micro_model_agent.infrastructure.evaluation_response_parsing import json_object_from_response
...
def score_synthetic_example(
    ...
    if refusal_expected:
        ...
        valid_arguments = valid_tool_arguments(response, errors)
...
def valid_tool_arguments(response: dict[str, Any], errors: list[str]) -> bool:
