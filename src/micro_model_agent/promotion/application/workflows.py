...
class RunPromotionGateWorkflow:
    ...
    def __init__(
        ...
        *,
        ...
        gate_service: PromotionGateService | None = None,
    ) -> None:
        self.artifact_reader = artifact_reader
        self.evaluation_reader = evaluation_reader
        self.result_writer = result_writer
        self.gate_service = gate_service or PromotionGateService()
    ...
    async def run(self, request: RunPromotionGateRequest) -> RunPromotionGateResult:
        ...
        for report_path in report_paths:
            ...
            can_promote = self.gate_service.meets_threshold(evaluation, request.minimum_score)
            evaluations.append(
